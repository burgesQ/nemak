...
;;   :init
;;   ;; Définir le keybinding sans charger swiper
;;   (global-set-key (kbd "C-s") 'swiper-isearch))
;;   ;; :config
;;   ;; :bind (("C-s" . swiper-isearch)))  ;; :bind est mieux pour ça
;; ;; TODO: add which key
;; ;;  (global-set-key (kbd "C-s") 'swiper-isearch))
#+end_src
...
(use-package lsp-mode
  ...
  ;; :demand t
  :hook (
         ;; (lsp-mode . nemaks/lsp-mode-setup)
  ...
  ;; Disable lsp pour certains modes
  ;; (add-to-list 'lsp-disabled-clients 'emacs-lisp-ls)

  :init
  ;; turn off problematic modes
  (setq lsp-disabled-clients '(semgrep-ls emacs-lisp-ls))
