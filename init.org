...
**** WIP other stuffs (windows, box)
*** TODO utils
*** TODO claude-el
*** TODO LSP
*** doc (how to use chapter)

* TODO the config [0/16]
:PROPERTIES:
:COOKIE_DATA: todo recursive
:END:
** early-init
...
***** TODO auto-scroll *Compilation* buffer

NOTE:  bind those toggle via `M-m E(rror) f(irst)` and `M-m E b(ottom)`.
#+begin_src emacs-lisp
